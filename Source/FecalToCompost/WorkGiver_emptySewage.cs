...

{
    ...
    public class WorkGiver_emptySewage : WorkGiver_Scanner
    {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            ...
            return t is Building_SepticTank septicBuilding && septicBuilding.GetSewage() > 800 && !t.IsBurning() && !t.IsForbidden(pawn) && pawn.CanReserveAndReach(t, PathEndMode.Touch, pawn.NormalMaxDanger(), 1);
        }

        public override Job JobOnThing(Pawn pawn, Thing t, bool forced = false)
        {
            return new Job(DefDatabase<JobDef>.GetNamed("emptySewage", true), t);
        }
